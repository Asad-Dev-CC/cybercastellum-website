...
<div class="about-service7-body d-flex align-items-center">
    ...
    <div class="about-service7-img-box d-flex">
        <img src="<?php echo esc_url(wp_get_attachment_image_url( $synckpagesaboutservicestyle4_output['abt_serv_img1']['id'], 'full' ));?>" alt="<?php echo get_post_meta($synckpagesaboutservicestyle4_output['abt_serv_img1']['id'], '_wp_attachment_image_alt', true); ?>" />
        <img src="<?php echo esc_url(wp_get_attachment_image_url( $synckpagesaboutservicestyle4_output['abt_serv_img2']['id'], 'full' ));?>" alt="<?php echo get_post_meta($synckpagesaboutservicestyle4_output['abt_serv_img2']['id'], '_wp_attachment_image_alt', true); ?>" />
    </div>
</div>
</div>
</section>
