...
<?php if ( $synckpagesnewsstyle4_output['row_switcher_options'] === 'yes' ) : ?>
<div class="sticky-news d-flex card-h">
<div class="news-img-box">
    <img src="<?php echo esc_url(wp_get_attachment_image_url( $synckpagesnewsstyle4_output['news_row_card_img']['id'], 'full' ));?>" alt="<?php echo get_post_meta($synckpagesnewsstyle4_output['news_row_card_img']['id'], '_wp_attachment_image_alt', true); ?>" />
</div>
...
<?php if ( $synckpagesnewsstyle4_output['col_switcher_options'] === 'yes' ) : ?>
...
<div class="news-item card-h">
    <div class="news-img-box">
        <img src="<?php echo esc_url(wp_get_attachment_image_url( $synckpagesnewsstyle4_loop['news_col_card_img']['id'], 'full' ));?>" alt="<?php echo get_post_meta($synckpagesnewsstyle4_loop['news_col_card_img']['id'], '_wp_attachment_image_alt', true); ?>" />
    </div>
