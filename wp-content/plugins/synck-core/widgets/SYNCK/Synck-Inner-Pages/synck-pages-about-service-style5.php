...
<img src="<?php echo esc_url(wp_get_attachment_image_url( $synckpagesaboutservicestyle5_output['abt_serv_bg_img']['id'], 'full' ));?>" class="<?php echo esc_attr($synckpagesaboutservicestyle5_output['bg_animation']);?> bg-shape" alt="<?php echo get_post_meta($synckpagesaboutservicestyle5_output['abt_serv_bg_img']['id'], '_wp_attachment_image_alt', true); ?>">
<div class="custom-container">
    <div class="custom-row align-items-center">
        <div class="img-box">
            <img src="<?php echo esc_url(wp_get_attachment_image_url( $synckpagesaboutservicestyle5_output['abt_serv_img']['id'], 'full' ));?>" alt="<?php echo get_post_meta($synckpagesaboutservicestyle5_output['abt_serv_img']['id'], '_wp_attachment_image_alt', true); ?>" />
        </div>
