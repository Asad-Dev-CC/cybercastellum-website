...
/**
 * Elementor synck synckpagesourteamdark Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Elementor_synck_synckpagesourteamstyle2_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Pages Our Team Style2', 'synck-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label'         => esc_html__( 'Our Team dark Section Style','synck-core' ),
        ...
        $this->start_controls_tab(
            'style_normal_tab_4',
            [
               'label' => esc_html__( 'Card Icons', 'synck-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'         => esc_html__( 'Card Icon Color', 'synck-core' ),
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'         => esc_html__( 'Card Icon Typography', 'synck-core' ),
                'selector'      => 
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}}  .our-team-black-area'=> 'background-color: {{VALUE}} !important;',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}}  .our-team-2-card'=> 'background-color: {{VALUE}} !important;',
                ],
        ...
        $this->add_control(
            'soccardbg_color',
            [
                'label'         => esc_html__( 'Social Card Background Color', 'synck-core' ),
                'type'          => \Elementor\Controls_Manager::COLOR,
                'selectors'     => [
                    '{{WRAPPER}}  .our-team-black-area .our-team-2-card .social-links'=> 'background: {{VALUE}} !important;',
                ],
    ...
    protected function render() {
        ...
        $synckpagesourteamdark_output = $this->get_settings_for_display(); ?>
...
<div class="left">
    <?php echo($synckpagesourteamdark_output['title_heading']); ?>
    <p><?php echo ($synckpagesourteamdark_output['content']); ?></p>
</div>

<?php if(!empty($synckpagesourteamdark_output['btn_title'] )): ?>
    <a <?php if($synckpagesourteamdark_output['btn_link']['is_external'] == true ): ?> target="_blank" <?php endif; ?>
    href="<?php echo esc_url($synckpagesourteamdark_output['btn_link']['url']); ?>" class="theme-btn"><?php echo esc_html($synckpagesourteamdark_output['btn_title']); ?></a>
<?php endif;?>
</div>

<div class="our-team-2-lists">
    <?php if(!empty($synckpagesourteamdark_output['list1'])):
        foreach ($synckpagesourteamdark_output['list1'] as $synckpagesourteamdark_loop):?>
    <div class="our-team-2-card">
        <div class="img-box">
            <img src="<?php echo esc_url(wp_get_attachment_image_url( $synckpagesourteamdark_loop['auth_img']['id'], 'full' ));?>" alt="<?php echo get_post_meta($synckpagesourteamdark_loop['auth_img']['id'], '_wp_attachment_image_alt', true); ?>" />
        </div>
        <h3><?php echo esc_html($synckpagesourteamdark_loop['auth_name']); ?></h3>
        <span class="designation"><?php echo esc_html($synckpagesourteamdark_loop['auth_designation']); ?></span>
        <ul class="social-links d-flex align-items-center">
            <li><a <?php if($synckpagesourteamdark_loop['soc_link1']['is_external'] == true ): ?> target="_blank" <?php endif; ?>
            href="<?php echo esc_url($synckpagesourteamdark_loop['soc_link1']['url']); ?>">
                <i class="<?php echo esc_attr($synckpagesourteamdark_loop['soc_icon1']);?>"></i>
            </a></li>
            <li><a <?php if($synckpagesourteamdark_loop['soc_link2']['is_external'] == true ): ?> target="_blank" <?php endif; ?>
            href="<?php echo esc_url($synckpagesourteamdark_loop['soc_link2']['url']); ?>">
                <i class="<?php echo esc_attr($synckpagesourteamdark_loop['soc_icon2']);?>"></i>
            </a></li>
            <li><a <?php if($synckpagesourteamdark_loop['soc_link3']['is_external'] == true ): ?> target="_blank" <?php endif; ?>
            href="<?php echo esc_url($synckpagesourteamdark_loop['soc_link3']['url']); ?>">
                <i class="<?php echo esc_attr($synckpagesourteamdark_loop['soc_icon3']);?>"></i>
            </a></li>
        </ul>
    </div>
