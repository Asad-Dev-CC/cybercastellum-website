...
<div class="blog-details-header-content-body d-flex align-items-center">
    ...
    <div class="img-box">
        <img src="<?php echo esc_url(wp_get_attachment_image_url( $synckpagesherostyle3_output['hero_bg_img']['id'], 'full' ));?>" alt="<?php echo get_post_meta($synckpagesherodark_output['hero_bg_img']['id'], '_wp_attachment_image_alt', true); ?>" />
    </div>
</div>
</div>
</section>
