...
/**
 * Elementor synck synckhomev1news Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Elementor_synck_synckhomev1news_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Home V1 News Style1', 'synck-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section4',
            [
                'label' => esc_html__( 'Cards Controls Section', 'synck-core' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );

        $this->add_control(
            'row_switcher_options',
            [
                'type'     => \Elementor\Controls_Manager::SWITCHER,
                'label'    => esc_html__( 'Row Card Info', 'synck-core' ),
        ...
        $this->add_control(
            'col_switcher_options',
            [
                'type'     => \Elementor\Controls_Manager::SWITCHER,
                'label'    => esc_html__( 'Column Card Info', 'synck-core' ),
                'default'  => 'yes', // Default value is 'true' for showing the menu
                'label_on'      => __( 'Show', 'synck-core' ),
                'label_off'     => __( 'Hide', 'synck-core' ),
                'return_value'  => 'yes',
        ...
        $this->start_controls_section(
            'synckhomev1newsrowcard_design_option',
            [
        ...
        $this->start_controls_section(
            'synckhomev1newscolcard_design_option',
            [
        ...
        $this->start_controls_section(
            'synckhomev1newsbg_design_option',
            [
    ...
    protected function render() {
        ...
        $synckhomev1news_output = $this->get_settings_for_display(); ?>
...
<div class="left">
    <?php echo($synckhomev1news_output['description']); ?>
</div>
<p><?php echo esc_html($synckhomev1news_output['content']); ?></p>
</div>

<?php if ( $synckhomev1news_output['row_switcher_options'] === 'yes' ) : ?>
<div class="sticky-news d-flex card-h">

<div class="news-img-box">
    <?php if(!empty($synckhomev1news_output['news_row_card_img'] )): ?>
    <img src="<?php echo esc_url(wp_get_attachment_image_url( $synckhomev1news_output['news_row_card_img']['id'], 'full' ));?>" alt="<?php echo get_post_meta($synckhomev1news_output['news_row_card_img']['id'], '_wp_attachment_image_alt', true); ?>" />
    <?php endif;?>
</div>

<div class="news-content">
    <h6 class="section-subtitle section-subtitle1"><?php echo esc_html($synckhomev1news_output['news_row_card_title']); ?></h6>
    <h2 class="section-title">
        <a <?php if($synckhomev1news_output['news_row_btn_arrow_link']['is_external'] == true ): ?> target="_blank" <?php endif; ?>
        href="<?php echo esc_url($synckhomev1news_output['news_row_btn_arrow_link']['url']); ?>"><?php echo($synckhomev1news_output['news_row_card_heading']); ?></a>
    </h2>
    <p><?php echo($synckhomev1news_output['news_row_card_content']); ?></p>
    <ul>

        <?php if(!empty($synckhomev1news_output['list2'])):
        foreach ($synckhomev1news_output['list2'] as $synckhomev1news_loop):?>
        <li>
            <i class="<?php echo esc_attr($synckhomev1news_loop['news_row_list_icon_class']);?>"></i> <?php echo esc_html($synckhomev1news_loop['news_row_list_icon_title']); ?>
        </li>
        <?php endforeach; endif;?>

    </ul>

<?php if(!empty($synckhomev1news_output['news_row_btn_arrow_icon'] )): ?>
    <a <?php if($synckhomev1news_output['news_row_btn_arrow_link']['is_external'] == true ): ?> target="_blank" <?php endif; ?>
    href="<?php echo esc_url($synckhomev1news_output['news_row_btn_arrow_link']['url']); ?>" class="theme-btn">
        <i class="<?php echo esc_attr($synckhomev1news_output['news_row_btn_arrow_icon']);?>"></i>
    </a>
    <?php endif;?>
...
<?php if ( $synckhomev1news_output['col_switcher_options'] === 'yes' ) : ?>
<div class="news-items align-items-start">
<?php if(!empty($synckhomev1news_output['list1'])):
        foreach ($synckhomev1news_output['list1'] as $synckhomev1news_loop):?>
<div class="news-item card-h">
    <div class="news-img-box">
        <img src="<?php echo esc_url(wp_get_attachment_image_url( $synckhomev1news_loop['news_col_card_img']['id'], 'full' ));?>" alt="<?php echo get_post_meta($synckhomev1news_loop['news_col_card_img']['id'], '_wp_attachment_image_alt', true); ?>" />
    </div>
    <div class="news-item-body">

            <h6 class="section-subtitle"><?php echo esc_html($synckhomev1news_loop['news_col_title']); ?></h6>
            <h2 class="section-title">
                <a <?php if($synckhomev1news_loop['news_col_btn_arrow_link']['is_external'] == true ): ?> target="_blank" <?php endif; ?>
                href="<?php echo esc_url($synckhomev1news_loop['news_col_btn_arrow_link']['url']); ?>"><?php echo ($synckhomev1news_loop['news_col_heading']); ?></a>
            </h2>
            <p><?php echo ($synckhomev1news_loop['news_col_content']); ?></p>

            <?php echo ($synckhomev1news_loop['news_col_list_icon_title']); ?>

<?php if(!empty($synckhomev1news_loop['news_col_btn_arrow_icon'] )): ?>
            <a <?php if($synckhomev1news_loop['news_col_btn_arrow_link']['is_external'] == true ): ?> target="_blank" <?php endif; ?>
            href="<?php echo esc_url($synckhomev1news_loop['news_col_btn_arrow_link']['url']); ?>" class="theme-btn">
                <i class="<?php echo esc_attr($synckhomev1news_loop['news_col_btn_arrow_icon']);?>"></i>
            </a>
<?php endif;?>
    </div>
</div>
